...
- Phthalates have been detected in children in the past, but there is less published  on the monitored impact of phthalate metabolites in this study population. 

- One study that measures a comprehensive survey of phthlate metabolites is the CDC's **National Health and Nutrition Examination Survey (NHANES)**, which contains measurements of phthalate concentrations in urine starting at age 3 in its 2017-2018 cohort released dataset.
- This national cohort study also measures serum levels of alpha-1-acid glycoprotein, a biomarker for inflammation, and chronic elevated inflammation can increase the risk of cardiovascular diseases. 

### Significance of Research Goals
- This research project would seek to add to the existing literature on phthalate exposure by focusing on the alternative metabolites that it rapidly breaks down into after human ingestion.
- We will seek to look at mixture effects of different phthalate metabolites, and if any chemicals appear to co-occur or interact together. 
- Leverage a nationally representative survey through the NHANES 2017-2018 Cohort Data, to evaluate potential vulnerabilities in one of the most vulnerable populations (infants and developing children).
