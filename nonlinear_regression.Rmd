...
cnp_l <- ggplot(data_cnp, aes(x = cnp, y = ssagp)) +
  ...
  labs(x = "CNP (ug/L)", y = "AGP (mg/mL)", title = "CNP") + 
  theme_classic()
```
...
cop_l <- ggplot(data_cop, aes(x = cop, y = ssagp)) +
  geom_point() + 
  geom_smooth(aes(y = predicted_ssagp), method = "lm", se = FALSE, color = "blue") +
  labs(x = "COP (ug/L)", y = "AGP (mg/mL)", title = "COP") + 
  theme_classic()
```
...
ecp_l <- ggplot(data_ecp, aes(x = ecp, y = ssagp)) +
  geom_point() + 
  geom_smooth(aes(y = predicted_ssagp), method = "lm", se = FALSE, color = "blue") +
  labs(x = "ECP (ug/L)", y = "AGP (mg/mL)", title = "ECP") + 
  theme_classic()
```
...
ecpt_l <- ggplot(data_ecpt, aes(x = ecpt, y = ssagp)) +
  geom_point() + 
  geom_smooth(aes(y = predicted_ssagp), method = "lm", se = FALSE, color = "blue") +
  labs(x = "ECPT (ug/L)", y = "AGP (mg/mL)", title = "ECPT") + 
  theme_classic()
```
...
hibp_l <- ggplot(data_hibp, aes(x = hibp, y = ssagp)) +
  geom_point() + 
  geom_smooth(aes(y = predicted_ssagp), method = "lm", se = FALSE, color = "blue") +
  labs(x = "HIBP (ug/L)", y = "AGP (mg/mL)", title = "HIBP") + 
  theme_classic()
```
...
mbp_l <- ggplot(data_mbp, aes(x = mbp, y = ssagp)) +
  geom_point() + 
  geom_smooth(aes(y = predicted_ssagp), method = "lm", se = FALSE, color = "blue") +
  labs(x = "MBP (ug/L)", y = "AGP (mg/mL)", title = "MBP") + 
  theme_classic()
```
...
mc1_l <- ggplot(data_mc1, aes(x = mc1, y = ssagp)) +
  geom_point() + 
  geom_smooth(aes(y = predicted_ssagp), method = "lm", se = FALSE, color = "blue") +
  labs(x = "MC1 (ug/L)", y = "AGP (mg/mL)", title = "MC1") + 
  theme_classic()
```
...
mep_l <- ggplot(data_mep, aes(x = mep, y = ssagp)) +
  geom_point() + 
  geom_smooth(aes(y = predicted_ssagp), method = "lm", se = FALSE, color = "blue") +
  labs(x = "MEP (ug/L)", y = "AGP (mg/mL)", title = "MEP") + 
  theme_classic()
```
...
mhbp_l <- ggplot(data_mhbp, aes(x = mhbp, y = ssagp)) +
  geom_point() + 
  geom_smooth(aes(y = predicted_ssagp), method = "lm", se = FALSE, color = "blue") +
  labs(x = "MHBP (ug/L)", y = "AGP (mg/mL)", title = "MHBP") + 
  theme_classic()
```
...
mhht_l <- ggplot(data_mhht, aes(x = mhht, y = ssagp)) +
  geom_point() + 
  geom_smooth(aes(y = predicted_ssagp), method = "lm", se = FALSE, color = "blue") +
  labs(x = "MHHT (ug/L)", y = "AGP (mg/mL)", title = "MHHT") + 
  theme_classic()
```
...
mib_l <- ggplot(data_mib, aes(x = mib, y = ssagp)) +
  geom_point() + 
  geom_smooth(aes(y = predicted_ssagp), method = "lm", se = FALSE, color = "blue") +
  labs(x = "MIB (ug/L)", y = "AGP (mg/mL)", title = "MIB") + 
  theme_classic()
```
...
moh_l <- ggplot(data_moh, aes(x = moh, y = ssagp)) +
  geom_point() + 
  geom_smooth(aes(y = predicted_ssagp), method = "lm", se = FALSE, color = "blue") +
  labs(x = "MOH (ug/L)", y = "AGP (mg/mL)", title = "MOH") + 
  theme_classic()
```
...
monp_l <- ggplot(data_monp, aes(x = monp, y = ssagp)) +
  geom_point() + 
  geom_smooth(aes(y = predicted_ssagp), method = "lm", se = FALSE, color = "blue") +
  labs(x = "MONP (ug/L)", y = "AGP (mg/mL)", title = "MONP") + 
  theme_classic()
```
...
mzp_l <- ggplot(data_mzp, aes(x = mzp, y = ssagp)) +
  geom_point() + 
  geom_smooth(aes(y = predicted_ssagp), method = "lm", se = FALSE, color = "blue") +
  labs(x = "MZP (ug/L)", y = "AGP (mg/mL)", title = "MZP") + 
  theme_classic()
```
