...
#from nonlinear regression rmd 
all_exp_outcome = inner_join(exp_outcome, demo, by = "seqn")
summary(all_exp_outcome)
#280 obs
...
ExtractPIPs(adj_fitkm, z.names = c("cnp", "cop", "ecp", "ecpt", "hibp", "mbp", "mc1", "mcoh", "mep", "mhbp", "mhh", "mhht", "mhnc", "mhp", "mib", "mnp", "moh", "monp", "mzp"))
...
ggplot(adj_responses.overall, aes(quantile, est, ymin = est - 1.96*sd, 
                              ymax = est + 1.96*sd)) + 
  geom_pointrange() + 
  ylab("Change in Expected AGP") + 
  plotTheme
